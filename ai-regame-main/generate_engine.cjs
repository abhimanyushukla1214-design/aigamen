...
export function generateGameHTML(spec: ComprehensiveGameSpec): string {
  ...
  return [
    ...
    '            ',
    '            if (config.isTopDown) {',
    '                platforms.push({ x: -50, y: -50, width: worldWidth+100, height: 50 }); ',
    '                platforms.push({ x: -50, y: worldHeight, width: worldWidth+100, height: 50 }); ',
    '                platforms.push({ x: -50, y: -50, width: 50, height: worldHeight+100 }); ',
    '                platforms.push({ x: worldWidth, y: -50, width: 50, height: worldHeight+100 }); ',
    '                ',
    '                for(let i=0; i<30; i++) {',
    '                    platforms.push({',
    ...
    '                }',
    '            } else {',
    '                platforms.push({ x: -50, y: height - 40, width: worldWidth+100, height: 100 }); ',
    '                platforms.push({ x: -50, y: -1000, width: 50, height: height+1000 }); ',
    '                platforms.push({ x: worldWidth, y: -1000, width: 50, height: height+1000 }); ',
    '                ',
    '                let currX = 200;',
